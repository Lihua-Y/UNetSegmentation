...
def cal_miou(test_dir=r"D:\segmentation\unet_EFLX\data\Test_Images",
             pred_dir="predict", gt_dir=r"D:\segmentation\unet_EFLX\data\Test_Labels"):
    # ---------------------------------------------------------------------------#
